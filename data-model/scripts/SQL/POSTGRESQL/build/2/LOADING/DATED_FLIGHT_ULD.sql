ALTER TABLE DATED_FLIGHT_ULD ADD CONSTRAINT UC_DATED_FLIGHT_ULD UNIQUE (DATED_FLIGHT_ID,ULD_TYPE_ID,ULD_CODE,ULD_OWNER_CODE);
/
...
CREATE INDEX IDX_DATED_FLIGHT_ULD_UC ON DATED_FLIGHT_ULD(DATED_FLIGHT_ID,ULD_TYPE_ID,ULD_CODE,ULD_OWNER_CODE);
/
