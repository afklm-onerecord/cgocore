package com.afklm.cargo.cgocore.populator.executor;
...
public class PopulatorLauncher {
	...
	public static void main(String[] args) {
		...
		try(FileSystemXmlApplicationContext appContext = new FileSystemXmlApplicationContext("classpath:applicationContext-cgocore-populator.xml",
																								"classpath:applicationContext-cgocore-repository.xml",
