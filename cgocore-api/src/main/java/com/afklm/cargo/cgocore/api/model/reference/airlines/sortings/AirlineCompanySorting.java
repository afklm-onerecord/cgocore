package com.afklm.cargo.cgocore.api.model.reference.airlines.sortings;
 ...
 */
public class AirlineCompanySorting implements Serializable {
...
private OrderType prefixOrderType;
...
public OrderType getPrefixOrderType() {
return this.prefixOrderType;
}

public void setPrefixOrderType(OrderType prefixOrderType) {
this.prefixOrderType = prefixOrderType;
}
