...
@Component({
selector: 'app-special-handling-code-list',
templateUrl: './special-handling-code-list.component.html',
styleUrls: ['./special-handling-code-list.component.scss']
})
export class SpecialHandlingCodeListComponent implements OnInit, AfterViewInit {

scrollForm: ScrollForm<SpecialHandlingCodeFilter, SpecialHandlingCodeSorting> = new ScrollForm();
scrollView: ScrollView<SpecialHandlingCodeBasicView> = new ScrollView();
dataSource:MatTableDataSource<SpecialHandlingCodeBasicView>;
...
constructor(private service:SpecialHandlingCodeRestClient, private formBuilder: FormBuilder, private dialog: MatDialog, private notifications: NotificationService) { }
ngOnInit(): void {
...
(event) => {
this.scrollForm.sorting = new SpecialHandlingCodeSorting();
...
this.scrollForm.filter = new SpecialHandlingCodeFilter();
this.scrollForm.sorting = new SpecialHandlingCodeSorting();
...
let ref = this.dialog.open(SpecialHandlingCodeModalComponent);
