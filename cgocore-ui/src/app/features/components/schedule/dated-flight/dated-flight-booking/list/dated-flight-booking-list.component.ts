...
displayedColumns: string[] = ['bookingAirWaybillAirWaybillNumber','numberOfPieces','grossWeight','grossWeightUnitOfMeasureCode','grossVolume','grossVolumeUnitOfMeasureCode','Actions'];
filter: FormGroup;
...
this.activePath = '/dated-flight/' + this.id.toString() + '/dated-flight-booking/list';
}
ngOnInit(): void {
