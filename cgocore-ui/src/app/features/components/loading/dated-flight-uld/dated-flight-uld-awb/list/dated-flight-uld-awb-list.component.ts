...
displayedColumns: string[] = ['airWaybillAirWaybillNumber','numberOfPieces','grossWeight','grossWeightUnitOfMeasureCode','grossVolume','grossVolumeUnitOfMeasureCode','Actions'];
filter: FormGroup;

constructor(private service:DatedFlightUldAwbRestClient, private route: ActivatedRoute, private formBuilder: FormBuilder, private dialog: MatDialog, private notifications: NotificationService) {
this.id = parseInt(this.route.snapshot.paramMap.get('id'));
this.activePath = '/dated-flight-uld/' + this.id.toString() + '/dated-flight-uld-awb/list';
}
ngOnInit(): void {
...
refresh(): void {
this.service.scrollFromDatedFlightUld(this.id, this.scrollForm).subscribe((t) => {
this.scrollView=t;
